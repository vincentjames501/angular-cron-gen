        ...
        return {
            ...
            link: function link($scope, elem, attrs, _ref) {
                ...
                var selectOptions = $scope.selectOptions = {
                    hours: state.use24HourTime ? [].concat(_toConsumableArray(new Array(24).keys())) : [].concat(_toConsumableArray(new Array(12).keys())).map(function (x) {
                        return x + 1;
                    }),
                ...
                $scope.$watch('ngModel', function (cron) {
                    ...
                    if (segments.length === 6 || segments.length === 7) {
                        ...
                        if (cron.match(/0 0\/\d+ \* 1\/1 \* \? \*/)) {
                            ...
                            state.daily.hours = processHour(_parsedHours);
                            state.daily.hourType = getHourType(_parsedHours);
                            ...
                            state.daily.hours = processHour(_parsedHours2);
                            state.daily.hourType = getHourType(_parsedHours2);
                            state.daily.minutes = parseInt(minutes);
                            ...
                            state.monthly.hours = processHour(_parsedHours4);
                            state.monthly.hourType = getHourType(_parsedHours4);
                            ...
                            state.monthly.hours = processHour(_parsedHours5);
                            state.monthly.hourType = getHourType(_parsedHours5);
                            state.monthly.minutes = parseInt(minutes);
                            ...
                            state.yearly.hours = processHour(_parsedHours6);
                            state.yearly.hourType = processHour(_parsedHours6);
                            ...
                            state.yearly.hours = processHour(_parsedHours7);
                            state.yearly.hourType = getHourType(_parsedHours7);
                            state.yearly.minutes = parseInt(minutes);
                        } else {
